...
public class MvpEquipConfig {
    ...
    public static List<Integer> EnhanceItem;
    ...
    public static List<Integer> EnhanceCosts;
    @Property(key="mvpequip.enhancerate", defaultValue="")
    public static String EnhanceRate;
    public static List<Integer> EnhanceRates;

    static {
        EnhanceItem = new LinkedList<Integer>();
        EnhanceCosts = new LinkedList<Integer>();
        EnhanceRates = new LinkedList<Integer>();
    }
}
